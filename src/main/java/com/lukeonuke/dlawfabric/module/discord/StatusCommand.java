...
public class StatusCommand implements SlashCommand {
    ...
    public void execute(SlashCommandInteractionEvent event, DlawFabric mod) {
        ...
        List<String> players = server.getPlayerList().getPlayers().stream().map(p -> Objects.requireNonNull(p.getDisplayName()).getString()).toList();
        EmbedBuilder builder = new EmbedBuilder()
                ...
                .addField("Version:", server.getServerVersion(), false)
